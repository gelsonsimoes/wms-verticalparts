...
// Mock de tarefas de alocação
const INITIAL_TASKS = [
  { id: '1', or: 'OR-5520', depositante: 'VERTICAL_DISTRIB', produto: 'VEPEL-BPI-174FX — Barreira Infravermelha', lote: 'L-9982', qtdTotal: 10, enderecoSugerido: 'R1_PP1_CL001_N004', status: 'Pendente' },
  { id: '2', or: 'OR-5521', depositante: 'TEC_LIFT_GLOBAL', produto: 'VPER-ESS-NY-27MM — Escova de Segurança', lote: 'L-4421', qtdTotal: 5, enderecoSugerido: 'R1_PP2_CL003_N005', status: 'Pendente' },
  { id: '3', or: 'OR-5521', depositante: 'TEC_LIFT_GLOBAL', produto: 'VPER-PAL-INO-1000 — Pallet Inox', lote: 'L-4422', qtdTotal: 12, enderecoSugerido: 'R2_PP1_CL002_N003', status: 'Pendente' },
];
...
export default function StockAllocation() {
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-24 font-['Poppins']">
      ...
      <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl overflow-hidden shadow-sm">
        <div className="p-4 bg-slate-50 dark:bg-slate-900/50 border-b border-slate-200 dark:border-slate-700 flex items-center justify-between">
          ...
          <div className="flex bg-slate-200 dark:bg-slate-700/50 p-0.5 rounded-lg">
            <button className="px-3 py-1 bg-white dark:bg-slate-800 rounded-md shadow-sm text-[8px] font-black uppercase text-primary">Hoje</button>
            <button className="px-3 py-1 text-[8px] font-black uppercase text-slate-400">Semana</button>
          </div>
        </div>
