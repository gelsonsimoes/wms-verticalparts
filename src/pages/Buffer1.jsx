...
const Buffer1 = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            if (error) {
                console.error('Erro Buffer1:', error);
            ...
            <div
                ...
                className={`
                    ...
                    ${occupied
                        ...
                        : 'bg-white/[0.03] border-white/10 text-white/30 hover:bg-blue-500/20 hover:border-blue-500/50 hover:text-blue-400 cursor-pointer'
                    }
    ...
    return (
        <EnterprisePageBase
            title="SISTEMA DE BUFFER #1"
            subtitle="Monitoramento Ativo de Área de Piso"
            actions={
            ...
            <div className="space-y-8 animate-fade-in animate-duration-500">
                    ...
                    <div className="md:col-span-3 vp-glass p-8 rounded-3xl flex items-center justify-between border border-white/5 bg-gradient-to-br from-white/[0.03] to-transparent">
                        <div className="flex gap-16">
                            <div className="flex flex-col gap-2">
                                <span className="text-[10px] font-black text-white/30 uppercase tracking-[0.3em]">OCUPAÇÃO ATUAL</span>
                            ...
                            <div className="flex flex-col gap-2 border-l border-white/10 pl-16">
                                <span className="text-[10px] font-black text-white/30 uppercase tracking-[0.3em]">EQUIPE ALOQUÊ</span>
                                <div className="flex -space-x-3">
                                    {[1,2,3].map(i => (
                                        <div key={i} className="w-10 h-10 rounded-full border-2 border-black bg-slate-800 flex items-center justify-center text-[10px] font-black">OP</div>
                                    ))}
                                </div>
                            </div>
                        </div>

                        <div className="hidden lg:flex items-center gap-4 bg-blue-500/10 border border-blue-500/20 p-4 rounded-2xl">
                            <Grid3X3 className="text-blue-500" size={32} />
                            <div>
                                <h3 className="text-sm font-black text-white">GRID OPERACIONAL</h3>
                                <p className="text-[10px] font-bold text-blue-400">POSIÇÕES 1A A 7N</p>
                            </div>
                        </div>
                    </div>

                    <div className="bg-red-500/10 border border-red-500/30 rounded-3xl p-8 flex flex-col justify-center relative overflow-hidden group">
                        <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:scale-150 transition-transform duration-700">
                             <XCircle size={100} />
                        </div>
                        <div className="flex items-center gap-3 mb-4">
                            <Info className="text-red-500" size={24} />
                            <span className="text-[10px] font-black bg-red-500 text-white px-3 py-1 rounded-full uppercase tracking-widest leading-none">ALERTA</span>
                        </div>
                        <h4 className="text-sm font-black text-white uppercase mb-2 tracking-tight">LIMITAÇÃO DE PISO</h4>
                        <p className="text-xs text-white/40 font-medium leading-relaxed">Área destinada a caixas volumosas. Não obstruir corredores laterais.</p>
                    </div>
                </div>
                ...
                <div className="relative vp-glass p-10 rounded-[2.5rem] border border-white/5 overflow-hidden">
                    ...
                    {loading && (
                        <div className="absolute inset-0 z-50 backdrop-blur-md flex flex-col items-center justify-center gap-4">
                            ...
                            <span className="text-[10px] font-black text-blue-500 tracking-[0.4em] uppercase">Sincronizando...</span>
                        </div>
                    )}
                            ...
                            <div className="vp-glass p-6 rounded-3xl border border-white/20 shadow-2xl backdrop-blur-3xl bg-black/60">
                                <div className="flex justify-between items-start mb-4 border-b border-white/10 pb-4">
                                    <div>
                                        ...
                                        <p className="text-[10px] font-black text-blue-500 mt-1 uppercase tracking-widest">LOCALIZAÇÃO ATIVA</p>
                                    </div>
                                ...
                                {hoveredPos.data ? (
                                    <div className="space-y-4">
                                        <div className="flex flex-col">
                                            <span className="text-[10px] font-black text-white/30 uppercase tracking-widest mb-1">Carga Atual</span>
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            <div className="flex flex-col">
                                                ...
                                                <span className="text-xs font-mono font-bold text-blue-400">{hoveredPos.data.sku}</span>
                                            </div>
                                    ...
                                    <p className="text-xs text-white/40 italic font-medium">Slot disponível para alocação imediata via RF ou Terminal.</p>
                                )}
                            </div>
                        </div>
                    )}
                ...
                <div className="flex gap-8 justify-center py-6">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-[10px] font-black text-white/40 uppercase tracking-widest underline decoration-blue-500/50 underline-offset-4">ÁREA DISPONÍVEL</span>
                    </div>
                    <div className="flex items-center gap-3">
